...
def information_screen(x, y):
    ...
    CPU_TEP_lab = tk.Label(root, width=18, text='CPU Temp:',
                           fg=color_text, bg='#212121')
    ...
    RAM_lab = tk.Label(root, width=18, text='RAM Usage:',
                       fg=color_text, bg='#212121')
    RAM_lab.place(x=x, y=y+60)  # Define a Label and put it in position

    l_ip_4 = tk.Label(root, width=18, text='GUI on RPi',
                      fg=color_text, bg='#F44336')
    l_ip_4.place(x=x, y=y+95)  # Define a Label and put it in position

    l_ip_5 = tk.Label(root, width=18, text='Using Python-TkInter',
                      fg=color_text, bg=color_btn)
...
def osd_screen(x, y):
    osd_X = tk.Label(root, width=16, text='Xpos: %s' %
                     var_X.get(), fg=color_text, bg='#212121')
    osd_X.place(x=x, y=y)

    osd_Y = tk.Label(root, width=16, text='Ypos: %s' %
                     var_Y.get(), fg=color_text, bg='#212121')
    osd_Y.place(x=x+160, y=y)

    osd_Z = tk.Label(root, width=16, text='Zpos: %s' %
                     var_Z.get(), fg=color_text, bg='#212121')
    osd_Z.place(x=x+320, y=y)

    osd_G = tk.Label(root, width=16, text='Gpos: %s' %
                     var_G.get(), fg=color_text, bg='#212121')
...
def switch_button(x, y):
    ...
    Btn_Switch_1 = tk.Button(root, width=6, text='Port 1',
                             fg=color_text, bg=color_btn, relief='ridge')
    Btn_Switch_2 = tk.Button(root, width=6, text='Port 2',
                             fg=color_text, bg=color_btn, relief='ridge')
    Btn_Switch_3 = tk.Button(root, width=6, text='Port 3',
                             fg=color_text, bg=color_btn, relief='ridge')
...
def scale_XYZ(x, y, w):
    ...
    canvas_cover = tk.Canvas(root, bg=color_bg, height=30,
                             width=510, highlightthickness=0)
...
def function_buttons(x, y):
    ...
    Btn_function_Xup = tk.Button(
        root, width=6, text='X+', fg=color_text, bg=color_btn, relief='ridge')
    Btn_function_Yup = tk.Button(
        root, width=6, text='Y+', fg=color_text, bg=color_btn, relief='ridge')
    Btn_function_Zup = tk.Button(
        root, width=6, text='Z+', fg=color_text, bg=color_btn, relief='ridge')
    Btn_function_Gup = tk.Button(
        root, width=6, text='G+', fg=color_text, bg=color_btn, relief='ridge')

    Btn_function_Xdo = tk.Button(
        root, width=6, text='X-', fg=color_text, bg=color_btn, relief='ridge')
    Btn_function_Ydo = tk.Button(
        root, width=6, text='Y-', fg=color_text, bg=color_btn, relief='ridge')
    Btn_function_Zdo = tk.Button(
        root, width=6, text='Z-', fg=color_text, bg=color_btn, relief='ridge')
    Btn_function_Gdo = tk.Button(
        root, width=6, text='G-', fg=color_text, bg=color_btn, relief='ridge')
