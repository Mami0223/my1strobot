...
'''
btn_on = tk.Button(root, width=8, text='ON', fg='#E1F5FE',
                   bg='#0277BD', command=lights_on)
...
'''
btn_off = tk.Button(root, width=8, text='OFF', fg='#E1F5FE',
                    bg='#0277BD', command=lights_off)
